...
```
vendor/bin/phpunit tests/unit/Espo/Modules/Leady
```
...
```
vendor/bin/phpunit tests/integration/Espo/Modules/Leady
```
...
* `build`
* `site/build`
* `site/application/Espo/Modules/Leady`
* `site/tests/unit/Espo/Modules/Leady`
* `site/tests/integration/Espo/Modules/Leady`
